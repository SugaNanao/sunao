    ...
    appearanceItems: [
      {
        id: 'app-a1',
        title: '髮型與五官',
        content: '灰白色蓬鬆短髮，左眼角下方有一顆極具辨識度的小淚痣。',
      },
      {
        id: 'app-a2',
        title: '神態氣質',
        content: '平時眉眼間常掛著如春風般溫和爽朗的笑意，但在球場上面對關鍵比分時，眼神會瞬間轉為銳利沉著。',
      },
      {
        id: 'app-a3',
        title: '身形細節',
        content: '身材勻稱精實，雙手因常年反覆托球而帶有薄繭，習慣在運動後用毛巾隨意擦拭汗水。',
      },
    ],
    ...
    relationshipItems: [
      {
        id: 'rel-a1',
        title: '澤村大地 / 東峰旭',
        content: '三年級默契絕佳的鐵三角戰友，無須言語便能託付後背的摯友。',
      },
      {
        id: 'rel-a2',
        title: '影山飛雄',
        content: '後輩天才二傳手，既是全力托舉支持的良師，也是相互尊重的隊友。',
      },
      {
        id: 'rel-a3',
        title: '日向翔陽',
        content: '經常給予溫暖鼓勵與戰術指導，非常喜愛後輩們充滿朝氣的樣子。',
      },
      {
        id: 'rel-a4',
        title: '宮原七緒',
        content: '自幼相伴的青梅竹馬兼戀人。全世界唯一能讓他毫無防備卸下防線、徹底做回任性幼稚自己的人。',
      },
    ],
    ...
    appearanceItems: [
      {
        id: 'app-b1',
        title: '髮型與五官',
        content: '略帶微捲的深栗色微長髮，眼眸是清澈明亮的琥珀棕色。笑起來眼睛會彎成治癒的月牙弧度。',
      },
      {
        id: 'app-b2',
        title: '服裝配件',
        content: '脖子上總是掛著一台膠卷相機或烏野配色的秒錶，日常以舒適可愛的日系休閒服與排球部運動服為主。',
      },
      {
        id: 'app-b3',
        title: '身形氣質',
        content: '身材嬌小纖細，給人親切無距離感的溫暖印象，像小太陽般散發元氣。',
      },
    ],
    ...
    relationshipItems: [
      {
        id: 'rel-b1',
        title: '清水潔子 / 谷地仁花',
        content: '經理團隊的好姐妹，平時一起分擔部活繁雜事務，也是分享少女戀愛心事的專屬閨蜜。',
      },
      {
        id: 'rel-b2',
        title: '烏野排球部全體',
        content: '全心守護的大男孩們，鏡頭裡記錄著所有人揮灑汗水與歡笑的每一個青春瞬間。',
      },
      {
        id: 'rel-b3',
        title: '菅原孝支',
        content: '最喜歡的青梅竹馬兼男朋友。從小學時的打鬧到如今十指緊扣，彼此生命早已無法分割。',
      },
    ],
